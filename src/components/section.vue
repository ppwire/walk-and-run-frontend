    ...
    <v-card min-height="100vh" max-height="auto">
      <v-row>
        ...
        <v-col md="9">
          ...
          <v-btn color="primary" @click="popUpAddSection">Add Section</v-btn>
          <v-btn color="blue lighten-5" @click="deleteSection = true">Manage Section</v-btn>
          <v-row justify="end">
            ...
            <template v-slot:default>
              ...
              <tbody>
                <tr v-for="section in sections" :key="section.sectionid">
                  ...
                  <td>
                    <v-btn @click="postDeleteSection(section.sectionid)">DELETE</v-btn>
                    <v-btn @click="postEditSection(section)">EDIT</v-btn>
                  </td>
                </tr>
              </tbody>
            </template>
